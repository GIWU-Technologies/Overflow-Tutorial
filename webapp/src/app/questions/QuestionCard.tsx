        ...
        <div className='flex gap-6 px-6'>
            <div className='flex flex-col items-end text-sm gap-3 min-w-[6rem]'>
                ...
                <div className={clsx('flex justify-end rounded', {
                    ...
                    'bg-green-600 text-green-50': question.hasAcceptedAnswer
                })}>
                    ...
                    <div className='flex justify-between pt-2'>
                        <div className='flex gap-2'>
                            {question.tagSlugs.map((slug) => (
                                <Chip key={slug} variant='secondary'>
                                    <Link href={`/questions?tag=${slug}`} className='border border-slate-300 rounded-2xl px-1 py-1'>
                                        {slug}
                                    </Link>
                                </Chip>
                            ))}
                        ...
                        <div className='text-sm flex items-center gap-2'>
                            <Avatar className='h-6 w-6 text-purple-200 bg-purple-600' color="default">
